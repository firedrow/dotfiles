...
# Path to your oh-my-zsh installation.
  export ZSH=/home/drowland/.oh-my-zsh
...
# Remote systems
alias droplet_home='ssh drowland@rowland.pw -i ~/.ssh/home_droplet'
alias droplet_5e='ssh breynolds@fivee-api.com -i ~/.ssh/5e-api'
